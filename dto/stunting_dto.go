...
const (
	...
	MESSAGE_FAILED_GET_STUNTING_CALENDAR  = "failed get stunting calendar" // New
	...
	MESSAGE_SUCCESS_GET_STUNTING_CALENDAR = "success get stunting calendar" // New
)
...
var (
	...
	ErrGetStuntingCalendar   = errors.New("failed to get stunting calendar data") // New
)
...
type (
	...
	// New DTO for calendar request
	StuntingCalendarRequest struct {
